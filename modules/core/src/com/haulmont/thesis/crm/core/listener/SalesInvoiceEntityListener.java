 ...
 */
@ManagedBean("crm_SalesInvoiceEntityListener")
public class SalesInvoiceEntityListener implements BeforeInsertEntityListener<InvDoc>, BeforeUpdateEntityListener<InvDoc> {
    ...
    @Override
    public void onBeforeUpdate(InvDoc entity) {
    ...
    @Override
    public void onBeforeInsert(InvDoc entity) {
