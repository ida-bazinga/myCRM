...
import com.haulmont.thesis.crm.entity.RegionDistrict;
 ...
 */
@ManagedBean("crm_RegionDistrictListener")
public class RegionDistrictListener implements BeforeUpdateEntityListener<RegionDistrict>, BeforeInsertEntityListener<RegionDistrict> {

    @Inject
    protected Persistence persistence;

    protected Log log = LogFactory.getLog(RegionDistrictListener.class);

    @Override
    public void onBeforeUpdate(RegionDistrict entity) {
    ...
    @Override
    public void onBeforeInsert(RegionDistrict entity) {
