...
public class StaffBrowser<T extends Staff> extends AbstractLookup {
    ...
    super.init(params);
        ...
        mainTable.addGeneratedColumn("reference", new Table.ColumnGenerator<Staff>() {
            @Override
            public Component generateCell(Staff entity) {
    ...
    protected Action createCreateAction() {
        return new AbstractAction("actions.createNew") {
            ...
            public void actionPerform(Component component) {
                ...
                final Staff newEntity = metadata.create(Staff.class);
                Staff currentEntity = mainDs.getItem();
                ...
                Window window = openEditor("crm$Staff.edit", newEntity, WindowManager.OpenType.THIS_TAB, params);
    ...
    protected Action createCreateGroupAction() {
        return new AbstractAction("createGroup") {
            ...
            public void actionPerform(Component component) {
                ...
                Window window = openEditor("crm$StaffGroup.edit", newEntity, WindowManager.OpenType.DIALOG, params);
        ...
        return new EditAction(mainTable) {
            ...
            public void actionPerform(Component component) {
                ...
                if (item.getIsGroup()!=null && item.getIsGroup()) {
                    window = openEditor("crm$Staffgroup.edit", item, WindowManager.OpenType.DIALOG, params);
                } else {
                    window = openEditor("crm$Staff.edit", item, WindowManager.OpenType.THIS_TAB, params);
                }
